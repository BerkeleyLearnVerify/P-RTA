...
print("Untrusted Run:", round(np.mean(untrusted_run/(untrusted_run + trusted_run)), 2))
print("Trusted Run:", round(np.mean(trusted_run/(untrusted_run + trusted_run)), 2))

print("Untrusted LowBatteryRun:", round(np.mean(untrusted_lowbatteryrun/(untrusted_lowbatteryrun + trusted_lowbatteryrun)), 2))
print("Trusted LowBatteryRun:", round(np.mean(trusted_lowbatteryrun/(untrusted_lowbatteryrun + trusted_lowbatteryrun)), 2))